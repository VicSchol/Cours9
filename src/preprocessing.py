...
def convert_to_text(val):
    ...
    if val is None:
        ...
        # Convertir chaque élément en texte
...
# %% --------------------------- GENERATION TEXTE FINAL AUTOMATIQUE ---------------------------
# Créer age_text lisible
...
# Colonnes à concaténer pour vectorisation
